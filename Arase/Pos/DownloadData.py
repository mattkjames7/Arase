...
def DownloadData(L=2,StartYear=2016,EndYear=2019,Overwrite=False):
	'''
	...
	outpath = Globals.DataPath+'Pos/L{:01d}/'.format(L)
	...
	for i in range(0,n):
		...
		urls,fnames = _GetCDFURL(Years[i],L)
		nu = np.size(urls)
